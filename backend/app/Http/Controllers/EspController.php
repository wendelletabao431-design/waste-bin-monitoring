...
class EspController extends Controller
{
     ...
     *
     *  8.0V =  0%   8.2V =  4%   8.4V =  9%   8.6V = 13%   8.8V = 17%
     *  9.0V = 22%   9.2V = 26%   9.4V = 30%   9.6V = 35%   9.8V = 39%
     * 10.0V = 43%  10.2V = 48%  10.4V = 52%  10.6V = 57%  10.8V = 61%
     * 11.0V = 65%  11.2V = 70%  11.4V = 74%  11.6V = 78%  11.8V = 83%
     * 12.0V = 87%  12.2V = 91%  12.4V = 96%  12.6V = 100%
     */
