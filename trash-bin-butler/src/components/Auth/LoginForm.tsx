    ...
    return (
        ...
        >
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <motion.div variants={inputVariants} className="flex items-center justify-end">
                    <button type="button" className="text-sm font-semibold text-green-500 hover:text-green-600 transition-colors">
                        Forgot password?
                    </button>
                </motion.div>
                ...
                <motion.button
                    ...
                    type="submit"
                    disabled={loading}
                    className="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-2xl shadow-sm text-sm font-bold text-white bg-green-500 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
                >
